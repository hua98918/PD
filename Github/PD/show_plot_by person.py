# -*- coding: utf-8 -*-
"""
Created on Mon Feb 20 16:13:23 2017
...
output_file = "C:\pakinsen\Vicon\Psteps.csv"
dn = "C:\pakinsen\Vicon\\"
fn = "P6"
...
straight_df = df[(df['position'] == 0) & name]
...
layout = go.Layout(barmode='group', xaxis=go.XAxis(type='names') ,title= fn+" GCT Bar Chart")
fig = go.Figure(data=data, layout=layout)
# IPython notebook
#py.iplot(fig, filename='GCT_Left_Right_errorbar')
url = py.plot(fig, filename= fn+' GCT_Left_Right_errorbar')
...
layout = go.Layout(barmode='group', xaxis=go.XAxis(type='names'),title= fn+" Swing Stance IDS Bar Chart" )
fig = go.Figure(data=data, layout=layout)
# IPython notebook
#py.iplot(fig, filename='Swing Stance IDS Bar Chart')
url = py.plot(fig, filename=fn+' Swing Stance IDS Bar Chart')
...
layout = go.Layout(barmode='group', xaxis=go.XAxis(type='names'),title= fn+ " Stride Height and Length Bar Chart" )
fig = go.Figure(data=data, layout=layout)
# IPython notebook
#py.iplot(fig, filename='Stride Height and Length Bar Chart')
url = py.plot(fig, filename=fn+' Stride Height and Length Bar Chart')
...
data = [trace1, trace2]
layout = go.Layout(barmode='group', xaxis=go.XAxis(type='names'),title= fn+ " Stride Velocity Bar Chart" )
fig = go.Figure(data=data, layout=layout)
# IPython notebook
#py.iplot(fig, filename='Stride Height and Length Bar Chart')
url = py.plot(fig, filename=fn+' Stride Velocity Bar Chart')
